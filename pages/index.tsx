...
const AboutMe: NextPage = () => {
  ...
  return (
    <AsideBar asideNavigationComponent={<AhmedhammedNavigation />}>
      <article itemScope itemType="aboutme">
        <MetaTags
        ...
        <div className="p-8 w-full">
          <Typography className="mb-16">
            ...
            <p className="md:text-lg text-secondary">
              ...
              web technologies and dreaming about building codding school which working on slowly. Arabic food is my
              style and regarding to social status, (Searching for soulmate ...).
            </p>
          </Typography>
